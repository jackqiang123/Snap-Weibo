	...
	<div class='leftPanel'>
		<img
			...
			<a href = 'javascript:void(0);'>
				<div class="sign-up-btn"	; style="margin-right: 10px;margin-top: 10px; text-align: center"; onclick="location = 'message.do'">	
			Posts My Blog</div>
			</a>
	...
	<table style='text-align: left; width: 510px; height: 88px;' border='0'
		...
		<tbody>
			...
			<%
				...
				List<Blah> blahs = (List<Blah>) request.getAttribute("snapblahs");
			...
			<tr>
				...
				<div style = "font-size:12px;font-family:sans serif; color = #FF0000"> Post By: <%=blah.getUsername() %>      Post Time: <%=new Date(blah.getDate().getTime()).toString()%> </div>
				<br>
